...
import com.skillw.pouvoir.internal.feature.container.operator.ContainerOperatorFlatten
import com.skillw.pouvoir.internal.feature.container.operator.ContainerOperatorNormal
import com.skillw.pouvoir.internal.feature.container.operator.ContainerOperatorString
...
abstract class Container {
    ...
    open fun addTable(table: String, player: Boolean, playerKey: Boolean, data: List<ContainerBuilder.Data>) {
        ...
        if (player && !playerKey && data.size == 2) {
            ...
            hostTableOperator[table] = ContainerOperatorNormal(containerTable, dataSource, data)
        }
    }
