 ...
 */
package com.skillw.pouvoir.api.bstat
...
import taboolib.module.metrics.MetricsBase
import java.io.*
import java.net.URL
    ...
    class MetricsBase(
        ...
        private fun submitData() {
            ...
            val chartData: Array<JsonObjectBuilder.JsonObject> = customCharts.stream()
                ...
                .toArray { arrayOf<JsonObjectBuilder.JsonObject>() }
            serviceJsonBuilder.appendField("id", serviceId)
            serviceJsonBuilder.appendField("customCharts", chartData)
            baseJsonBuilder.appendField("service", serviceJsonBuilder.build())
            baseJsonBuilder.appendField("serverUUID", serverUuid)
            baseJsonBuilder.appendField("metricsVersion", taboolib.module.metrics.MetricsBase.METRICS_VERSION)
        ...
        companion object {
            ...
            const val METRICS_VERSION = "3.0.0"
