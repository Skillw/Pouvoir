...
import com.skillw.pouvoir.taboolib.module.ui.type.Basic
 ...
 */
class ClickEvent(
    private val bukkitEvent: InventoryInteractEvent,
    ...
    fun getItems(slot: Char): List<ItemStack> {
        return builder.slots.flatten().mapIndexedNotNull { index, c ->
            if (c == slot) inventory.getItem(index) ?: ItemStack(Material.AIR) else null
        }
    }
